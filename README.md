...
> - 발표 목표는 실적 자랑이 아니라 **함께할 사람과의 접점 만들기**입니다. 마지막 17페이지 CTA가 그 역할을 합니다.
>
...
| 05 | **1단계 검증** — Prototype → Go/No-Go → "가능성은 확인했습니다 / 이제 시작" | 6 |
...
| 17 | **마지막 메시지 · 함께하실 분** — Q&A 중에도 CTA가 화면에 남는다 | 3 |
